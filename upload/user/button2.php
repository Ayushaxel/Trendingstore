...
<body>
    ...
    <div class="x11">
        <div class="row mt-5 mx-5 ">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class=" mx-2 ms-3">
                    <span class=""><a href="" class="  "><img src="./all iamge/crazy1.webp" alt="" width=" 100%"></a>
            ...
            <div class="col-lg-3 col-sm-6 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=" "><img src="./all iamge/crazy2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/crazy3.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="xx12">
        <div class="d-flex mt-5 ">
            <div class="mx-2 ">
                <span><a href=""><img src="./all iamge/crazy2.webp" alt="" width="100%"></a>
            ...
            <div class="mx-2">
                <span><a href=""><img src="./all iamge/crazy3.webp" alt="" width="100%"></a>
    ...
    <div class="mt-5 x11">
        <div class="row mx-5 ">
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/royal1.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/royal2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/royal3.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="xx12">
        <div class="d-flex mt-5 ">
            <div class="mx-2 ">
                <span><a href=""><img src="./all iamge/royal2.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="ms-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="mx-2">
                <span><a href=""><img src="./all iamge/royal3.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="m-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="xx12">
        <div class="d-flex mt-5 ">
            ...
            <div class="mx-2">
                <span><a href=""><img src="./all iamge/classic1.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="m-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
