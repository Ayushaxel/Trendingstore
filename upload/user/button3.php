...
<body>
    ...
    <div class="">
        <p class="p-2" style="font-size: 15px !important; background-color: aliceblue !important;">Home | 𝗛𝗮𝗹𝗳 𝗢𝘃𝗲𝗿𝘀𝗶𝘇𝗲𝗱 𝗛𝗼𝗼𝗱𝗶𝗲𝘀
        </p>
    </div>
        ...
        <div class="row mt-5 mx-5 ">
            <div class="col-lg-3  ">
                <div class="">
                    ...
                    <div class="mb-3">
                        <p class="mb-2">10</p>
                        <input type="range" class="form-range w-100" id="rangeInput" name="rangeInput" min="0" max="500" value="254" oninput="amount.value=rangeInput.value">
          ...
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class=" mx-2 ms-3">
                    <span class=""><a href="" class="  "><img src="./all iamge/moon1.webp" alt="" width=" 100%"></a>
            ...
            <div class="col-lg-3 col-sm-6 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=" "><img src="./all iamge/moon2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <center class="mt-5 mb-5">
        ...
        <button class="" style="padding: 5px 15px 5px 15px   !important; border: none !important;  border: 1px solid black !important;"><i class="fa-solid fa-caret-left"></i></button>
    </a>
    <a href="halforversized.html" style="text-decoration: none !important;">
        <button class="" style="padding: 5px 15px 5px 15px   !important; border: none !important ; border: 1px solid black !important;">1</button>
    </a>
      <a href="button2.html" style="text-decoration: none !important;">  <button class="" style="padding: 5px 15px 5px 15px   !important; border: none !important;  border: 1px solid black !important;" >2</button></a>
        <a href="button3.html" style="text-decoration: none !important;"> <button class="" style="padding: 5px 15px 5px 15px   !important; border: none !important; border: 1px solid black !important;">3</button></a>
        <button class="" style="padding: 5px 15px 5px 15px   !important; border: none !important;  border: 1px solid black !important;"><i class="fa-solid fa-caret-right"></i></button>
    </center>
        ...
        <div class="row bx001">
            <div class="col-lg-4 col-sm-4">
                <div class="mx-5 mt-5" style="flex-direction: column !important;">
                    ...
                    <span><a href="" class="text-white"
                            style="text-decoration: none !important;">Shop</a></span><br>
                    <span><a href="" class="text-white"
                            style="text-decoration: none !important;">Contact</a></span><br>
