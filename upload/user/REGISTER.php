...
<body>
                ...
                <div class="collapse navbar-collapse d-flex justify-content-between" id="collapsibleNavbar">
                    <ul class="navbar-nav   d-flex justify-content-center align-content-center " style="margin-left:17rem !important; font-size: 13px !important;">
                        <li class="nav-item ted ">
                            <a class="nav-link text-dark mx-1 header-menu " href=" active" style="color: red !important;">HOME</a>
                        </li>
                        <li class="nav-item">
                            <div class="hover1">
            ...
            <div class="">
                <div class=" d-flex p-4 ms-4 ">
                    <div class="w-100" style="border-bottom: 1px solid rgb(152, 151, 151);">
                        <input type="" class="" style=" border: 0; outline: none!important; width: 97%;" placeholder="search for products, brands and more..">
    ...
    <div class="box22">
        <div class=" d-flex justify-content-center align-items-center mx-3 ">
            ...
            <div class="">
                <a class="navbar-brand" href="#"><img src="./all iamge/trand.avif" alt="" height="80px" style="align-items: center !important; margin-right: 33px !important;"></a>
            </div>
    ...
    <div class="">
        <p class="p-2" style="font-size: 15px !important; background-color: aliceblue !important;">Home | Create Account
        </p>
    </div>
    <div class="">
        <center class="mt-3">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12   mt-5">
                <center><input id="fname" type="text" placeholder="First Name" class="w-50 py-2 mb-4 ps-3 bx15" style="outline: none !important;" autofocus> </center>
                <center> <input id="lname" type="text" placeholder="Last Name" class="w-50 py-2 mb-4 ps-3" style="outline: none !important;"></center>
                <center> <input id="email" type="text" placeholder="Email" class="w-50 py-2 mb-4 ps-3" style="outline: none !important;"></center>
                <center><input type="password" name="" id="pass" placeholder="password" class=" py-2  w-50 py-2 mb-4 ps-3 " style="outline: none !important;"></center>
                <center><p id="error" class="text-danger"></p></center>
                <center class="cb2 mt-3" style="margin-right: 180px !important;"> <input type="checkbox" class=" me-3" style="font-size: 40px !important;">Subscribe to stay updated with new products and offers!
                </center>
                <center class="x32 mb-5">
                    <button class="mb-4 mt-5 bg-black text-white x32" style="border: none !important; border: 1px solid black !important; padding: 4px 20px 4px 20px !important;" onclick="register()">SUMIT</button>
                </center>
            </div>
            <script>
                function register() {
                    ...
                    if (fname==''|| lname==''|| email==''||pass=='') {
                        ...
                        document.getElementById("error").innerText='please fill the all details';
                    }else{
