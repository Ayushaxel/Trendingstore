...
$data = $conn->query("SELECT * FROM updatedetails where email='$loginemail'");
...
<div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="p-3 row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="number" class="form-control form-control_1" name="phone" id="phone" value="<?php echo $phone ?>">
                    </div>
                    <div class="col-lg-6">
                        <label for="address" class="form-label fs-5">Address <sup>*</sup></label>
                        <input type="text" class="form-control form-control_1" name="address" id="address" value="<?php echo $address ?>">
                    </div>
    ...
    if (isset($_POST['update'])) {
        ...
        $imgaddres = "../upload/" . $imagename;
        $data = $conn->query("UPDATE `updatedetails` SET `firstname`='$name',`lastname`='$last',`email`='$email',`phone`='$phone',`address`='$useraddres',`profilepic`='$imagename' where email='$loginemail'");
        if ($data) {
            move_uploaded_file($tempname, $imgaddres);
            echo "   <script> 
                          alert('update');
                    </script>";
