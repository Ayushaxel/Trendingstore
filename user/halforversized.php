...
<body>
                ...
                <div class="collapse navbar-collapse d-flex justify-content-between" id="collapsibleNavbar">
                    <ul class="navbar-nav   d-flex justify-content-center align-content-center "
                        ...
                        <li class="nav-item ted ">
                            <a class="nav-link text-dark mx-1 header-menu " href=" active"
                            ...
                            <div class="hover1">
                                <div class="text-dark mx-1 allcollection header-menu" href="#">ALL COLLECTION
                                    <ul class="allcollection_dropdown shadow">
                                        <li><a href="#" class="text-dark">HALF OVERSIZED HOODIE</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark mx-1 header-menu" href="#">CONTACT US </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark mx-1 header-menu" href="#">TRACK ORDER </a>
                        </li>
                    </ul>
                    <div class="">
                        <div class=" mx-5">
    ...
    <div class="modal" id="smmodal">
        <div class="modal-dialog shadow bg-white w-75 "
            ...
            <div class="modal-content">
                ...
                <div class="">
                    <h5 class="mt-4 ms-4 mb-3 fs-6">LANGAUGE</h5>
    ...
    <div class="">
        <p class="p-2" style="font-size: 15px !important; background-color: aliceblue !important;">Home | 𝗛𝗮𝗹𝗳
            𝗢𝘃𝗲𝗿𝘀𝗶𝘇𝗲𝗱 𝗛𝗼𝗼𝗱𝗶𝗲𝘀
        </p>
    </div>

    <!-- grid swiper show now ...///// -->
    <div class="x11">
        <div class="row mt-5 mx-5 ">
            <div class="col-lg-3  ">
                <div class="">
                    <h6 class="mt-3 ms-3 mb-4">𝗖𝗔𝗧𝗘𝗚𝗢𝗥𝗜𝗘𝗦</h6>
                    <h6 class="ms-3 mb-3">𝗔𝗩𝗔𝗜𝗟𝗔𝗕𝗜𝗟𝗜𝗧𝗬</h6>
                    <span class="ms-3"><input type="checkbox"> In stock</span><br>
                    <span class="ms-3"><input type="checkbox"> In stock</span>
                    <h6 class="mt-2 ms-3">PRICE</h6>
                    <div class="mb-3">
                        <p class="mb-2">10</p>
                        <input type="range" class="form-range w-100" id="rangeInput" name="rangeInput" min="0" max="500"
                            value="254" oninput="amount.value=rangeInput.value">
                        <output id="amount" name="amount" min-velue="0" max-value="500" for="rangeInput">254</output>
                        
                    </div>
                    <h6 class="ms-3 mt-4 mb-3">𝗣𝗢𝗣𝗨𝗟𝗔𝗥 𝗣𝗥𝗢𝗗𝗨𝗖𝗧𝗦</h6>
                    <p class="me-1 ms-2" style="font-size: 14px !important;">Please select collection from store admin >
                        customize > Collection page > sidebar</p>
                </div>

            </div>
            <div class="col-lg-3 col-sm-6">
                <div class=" mx-2 ms-3">
                    <span class=""><a href="" class="  "><img src="./all iamge/winged1.webp" alt="" width=" 100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
                            1,700.00</span>
            ...
            <div class="col-lg-3 col-sm-6 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=" "><img src="./all iamge/winged2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/winged3.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="xx12">
        <div class="d-flex mt-5 ">
            <div class="mx-2 ">
                <span><a href=""><img src="./all iamge/winged2.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="ms-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
                        1,700.00</span>
                    <span class="text-danger">Rs 1,200.00</span>
                </span>
            </div>
            <div class="mx-2">
                <span><a href=""><img src="./all iamge/winged3.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="m-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
                        1,700.00</span>
    ...
    <div class="mt-5 x11">
        <div class="row mx-5 ">
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/fire1.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/fire2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/fire3.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <!-- mobile swiper show now .../// -->

    <div class="xx12">
        <div class="d-flex mt-5 ">
            <div class="mx-2 ">
                <span><a href=""><img src="./all iamge/fire1.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="ms-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="mx-2">
                <span><a href=""><img src="./all iamge/fire3.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="m-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="mt-5 x11">
        <div class="row mx-5 ">
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/play1.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/play2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/play3.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="xx12">
        <div class="d-flex mt-5 ">
            <div class="mx-2 ">
                <span><a href=""><img src="./all iamge/play3.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="ms-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="mt-5 x11">
        <div class="row mx-5 ">
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/classic1.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/classic2.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="col-lg-3 ">
                <div class="mx-2 ms-3">
                    <span class=""><a href="" class=""><img src="./all iamge/classic3.webp" alt="" width="100%"></a>
                        <span class="ms-2" style="font-size: 14px !important;">winged Desert Legacy printed Hoodie
                        </span>
                        <span class="ms-5"
                            style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="xx12">
        <div class="d-flex mt-5 ">
            <div class="mx-2 ">
                <span><a href=""><img src="./all iamge/classic2.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="ms-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
            ...
            <div class="mx-2">
                <span><a href=""><img src="./all iamge/classic3.webp" alt="" width="100%"></a>
                    <span class="" style="font-size: 17px !important;">winged Desert Legacy <span class="m-3"> printed
                            Hoodie</span>
                    </span><br>
                    <span class="" style="text-decoration: line-through !important; font-size: 14px !important;">Rs
    ...
    <div class="" style="border-top: 1px solid dotted rgb(231, 15, 15) !important ;"></div>

    <center class="mt-5 mb-5">
        <a href="" style="text-decoration: none !important;">
            <button class=""
                style="padding: 5px 15px 5px 15px   !important; border: none !important;  border: 1px solid black !important;"><i
                    class="fa-solid fa-caret-left"></i></button>
        </a>
        <a href="halforversized.php" style="text-decoration: none !important;">
            <button class=""
                style="padding: 5px 15px 5px 15px   !important; border: none !important ; border: 1px solid black !important;">1</button>
        </a>
        <a href="button2.php" style="text-decoration: none !important;"> <button class=""
                style="padding: 5px 15px 5px 15px   !important; border: none !important;  border: 1px solid black !important;">2</button></a>
        <a href="button3.php" style="text-decoration: none !important;"> <button class=""
                style="padding: 5px 15px 5px 15px   !important; border: none !important; border: 1px solid black !important;">3</button></a>
        <button class=""
            style="padding: 5px 15px 5px 15px   !important; border: none !important;  border: 1px solid black !important;"><i
